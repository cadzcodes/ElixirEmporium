...
const ProductPage = () => {
    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            setAlerts((prev) => [
                ...prev,
                { id, type: "error", message: "Error adding to cart" },
            ]);
        } finally {
            setAdding(false);
        }
            ...
            <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center z-10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center border border-gray-400 rounded-full overflow-hidden bg-black/40">
                            <button
                                ...
                                className={`w-8 h-8 text-lg flex items-center justify-center transition ${
                                    isOutOfStock
                    ...
                    <button
                        ...
                        className={`cursor-pointer px-6 py-3 rounded-full font-semibold transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                            isOutOfStock
